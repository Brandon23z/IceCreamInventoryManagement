    ...
    class SQLMethods
    {
        public static void initializeDatabase()
        {
            if (!File.Exists("database.FDB"))
            {
                ...
                SQL.sqlnonquery("CREATE TABLE CITIES(citylabel VARCHAR(30) NOT NULL PRIMARY KEY, cityname VARCHAR(30) NOT NULL, state VARCHAR(2) NOT NULL);");
                ...
                SQL.sqlnonquery("CREATE TABLE SALES(itemnumber int NOT NULL, quantity int NOT NULL, saledate timestamp NOT NULL, initialprice decimal NOT NULL, saleprice decimal NOT NULL);");
            }
        }
    }
}
